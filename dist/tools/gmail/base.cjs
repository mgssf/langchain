...
class GmailBaseTool extends base_js_1.StructuredTool {
    constructor(fields) {
        super(...arguments);
        Object.defineProperty(this, "CredentialsSchema", {
            ...
            value: zod_1.z
                ...
                clientEmail: zod_1.z
                    .string()
                    .min(1)
                    .default((0, env_js_1.getEnvironmentVariable)("GMAIL_CLIENT_EMAIL") ?? ""),
                privateKey: zod_1.z
                    .string()
                    .default((0, env_js_1.getEnvironmentVariable)("GMAIL_PRIVATE_KEY") ?? ""),
                keyfile: zod_1.z
                    .string()
                    .default((0, env_js_1.getEnvironmentVariable)("GMAIL_KEYFILE") ?? ""),
            })
